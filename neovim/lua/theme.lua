-- modified from https://github.com/soft-aesthetic/soft-era-vim
...
let g:colors_name="soft_era"


let Italic = ""
if exists('g:soft_era_italic')
  let Italic = "italic"
endif
let g:soft_era_italic = get(g:, 'soft_era_italic', 0)

let Bold = ""
if exists('g:soft_era_bold')
  let Bold = "bold"
endif

let g:soft_era_bold = get(g:, 'soft_era_bold', 0)
...
hi Comment guifg=#9c9a9a ctermfg=252 gui=NONE cterm=NONE
...
hi Boolean guifg=#ec57b4 ctermfg=205 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
...
hi Statement guifg=#ec57b4 ctermfg=205 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Conditional guifg=#82b4e3 ctermfg=110 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
hi Repeat guifg=#82b4e3 ctermfg=110 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
hi Label guifg=#82b4e3 ctermfg=110 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
hi Operator guifg=#ec57b4 ctermfg=205 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi Keyword guifg=#82b4e3 ctermfg=110 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
...
hi Include guifg=#82b4e3 ctermfg=110 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
hi Define guifg=#82b4e3 ctermfg=110 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
...
hi Type guifg=#b4addf ctermfg=146 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
hi StorageClass guifg=#b4addf ctermfg=146 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
hi Structure guifg=#b4addf ctermfg=146 guibg=NONE ctermbg=NONE gui=Bold,Italic cterm=Bold,Italic
...
hi Whitespace guifg=#d8d0cb ctermfg=252 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi NonText guifg=#d8d0cb ctermfg=252 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi SignColumn guifg=#e2d1d1 ctermfg=252 guibg=#f9f5f5 ctermbg=255 gui=NONE cterm=NONE
hi LineNr guifg=#e2d1d1 ctermfg=252 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi QuickBG guifg=NONE ctermfg=NONE guibg=#f9f5f5 ctermbg=255 gui=NONE cterm=NONE
hi QuickSel guifg=NONE ctermfg=NONE guibg=#a29acb ctermbg=140 gui=NONE cterm=NONE
hi QuickKey guifg=#ec57b4 ctermfg=205 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi QuickOff guifg=NONE ctermfg=NONE guibg=#f2edec ctermbg=255 gui=NONE cterm=NONE
hi QuickHelp guifg=#d8d0cb ctermfg=252 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi phpMemberSelector guifg=#ec57b4 ctermfg=205 guibg=NONE ctermbg=NONE gui=NONE cterm=NONE
hi htmlArg guifg=#b4addf ctermfg=146 guibg=NONE ctermbg=NONE gui=Italic cterm=Italic
